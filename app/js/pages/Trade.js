                    ...
                    <div className='wrapper'>
                        ...
                        <div className='trading__row'>
                            <div className='trading__item'>
                                <div className='main-pair'>
                                    <label className='main-pair'>BTC/USD</label><span className='text-negative'>Low:</span> 6544.51 USD / <span className='text-positive'>High:</span> 7339.8 USD <span className='text-positive'>0.63%</span>
                                </div>
                            ...
                            <div className='trading__item'>
                                <div className='tickets'>
                                    <nav className='tickets__top-pair'>
                                        <a className='tickets__btn'>Избранное</a>
                                        ...
                                        <a className='tickets__btn'>XLM</a>
                                        <a className='tickets__btn'>LTC</a>
                                        <a className='tickets__btn'>ADA</a>
                        ...
                        <div className='trading__row'>
                            <div className='orders-sell'>
                                <table className='orders-sell__table'>
                                    <thead>
                                        <tr>
                                            <th>Цена</th>
                                            <th>ADA</th>
                            ...
                            <div className='orders-buy'>
                                <table className='orders-buy__table'>
                                    <thead>
                                        <tr>
                                            <th>Цена</th>
                                            <th>ADA</th>
